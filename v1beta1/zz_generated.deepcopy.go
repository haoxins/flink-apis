...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobStatusSpec) DeepCopyInto(out *JobStatusSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobStatusSpec.
func (in *JobStatusSpec) DeepCopy() *JobStatusSpec {
	if in == nil {
		return nil
	}
	out := new(JobStatusSpec)
	in.DeepCopyInto(out)
	return out
}
